...
begin
  ...
  begin
    Result.Mensage := 'Erro! O campo Estado deve conter no máximo 50 caracteres';
    Exit;
  end;

  if aEndereco.Cidade.Length > 50 then
  begin
    Result.Mensage := 'Erro! O campo Cidade deve conter no máximo 100 caracteres';
    Exit;
  end;

  if aEndereco.Bairro.Length > 50 then
  begin
    Result.Mensage := 'Erro! O campo Bairro deve conter no máximo 50 caracteres';
    Exit;
  end;

  if aEndereco.Logradouro.Length > 50 then
  begin
    Result.Mensage := 'Erro! O campo Logradouro deve conter no máximo 100 caracteres';
    Exit;
  end;

  if aEndereco.Complemento.Length > 100 then
  begin
    Result.Mensage := 'Erro! O campo Complemento deve conter no máximo 100 caracteres';
    Exit;
  end;
